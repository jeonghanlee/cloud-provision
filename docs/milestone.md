...
```
In progress (🔄):  none
Done (✅):  M1.1 · M1.2 · M1.3 · M2.1 · M2.2 · M2.3 · M2.4 · M2.5 · M3.1 · M5.1 · M5.2 · M5.3

Next entry points:
  ▶ ready now:   M1.4 · M3.2 · M3.4 · M4.1 · M4.2 · M4.3 · M4.4 · M4.5
...
Tally: 23 tasks - ✅ 12 · 🔄 0 · ⬜ 8 · 🔒 3 / ready(▶) 8 · external gates 3 (G1 · G2 · G3)
