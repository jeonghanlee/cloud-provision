...
| M8 / T5 | 2026-08-25 | Supported Libvirt/KVM; debian13 iocrunner golden bake with the P_python operator (D023) | Pass (partial) | The debian13 iocrunner bake completes end to end: P_python provisions pip so the Step 5/8 provenance records 58 `pip3` lines, the terminal seal reports `clean=true` with 8 identities, and the pair publishes (`iocrunner-debian13-20260826T000350Z-...`). The rocky8 iocrunner bake, one iocrunner-nfs bake, and fresh consumer selection remain for T5. |
